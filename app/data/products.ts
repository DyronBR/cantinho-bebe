export interface Product {
    ...
    const products: Product[] = [
    {
        ...
        fullDescription: "Bodie azul super macio em algodão orgânico puro, sem químicos. Perfeito para recém-nascidos de 0-12 meses, garante conforto delicado e proteção carinhosa o dia todo. Ideal para o dia a dia com máximo conforto.",
        specifications: {
            "Material": "Algodão Orgânico 100%",
            "Idade": "0-12 meses",
            "Cores": "Azul",
            "Lavagem": "Água morna, sabão neutro"
        }
    },
    {
        id: 2,
